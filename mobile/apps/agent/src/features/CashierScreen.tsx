...
import { Balance, Card, EmptyState, Logo, Row, Screen, Skeleton, Text, useTheme } from '@ticash/ui';
  ...
  return (
    <Screen scroll>
      ...
      <Row gap={3} style={{ marginTop: t.spacing(5) }}>
        <Card onPress={() => { /* WS-3 */ }} style={{ flex: 1, alignItems: 'center', paddingVertical: t.spacing(5), gap: t.spacing(2) }}>
