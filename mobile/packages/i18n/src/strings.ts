...
export const en = {
  ...
  auth: {
    ...
    forgot: 'Forgot password?', firstAccess: 'First time or forgot password?', forgotSubtitle: 'Enter your phone to receive a code.', codeSent: 'Code sent',
    resetTitle: 'New password', resetPassword: 'Reset password',
    referralCode: 'Referral code', referralCodeHint: 'If a friend invited you (optional)',
  ...
  referral: {
    title: 'Invite & earn', subtitle: 'Share your code. When a friend signs up and makes their first transaction, you earn {bonus}.',
    yourCode: 'Your code', share: 'Share', copied: 'Copied',
    shareMessage: 'Join me on Ticash Pay! Use my code {code} when you sign up.',
    invited: 'Invited', active: 'Active', earned: 'Earned',
    howTitle: 'How it works', step1: 'Share your code with friends', step2: 'They sign up with it',
    step3: 'They make their first transaction', step4: 'You earn {bonus}',
  },
  agent: {
    ...
    onboardingNote: 'Agent accounts are created by the Ticash admin. Ask your admin to register you, then set your password on first access.',
  },
  send: {
...
export const pt: Dictionary = {
  ...
  auth: {
    ...
    forgot: 'Esqueceu a senha?', firstAccess: 'Primeiro acesso ou esqueceu a senha?', forgotSubtitle: 'Digite seu telefone para receber um código.', codeSent: 'Código enviado',
    resetTitle: 'Nova senha', resetPassword: 'Redefinir senha',
    referralCode: 'Código de indicação', referralCodeHint: 'Se um amigo te convidou (opcional)',
  ...
  referral: {
    title: 'Indique e ganhe', subtitle: 'Compartilhe seu código. Quando um amigo se cadastra e faz a primeira transação, você ganha {bonus}.',
    yourCode: 'Seu código', share: 'Compartilhar', copied: 'Copiado',
    shareMessage: 'Entra comigo no Ticash Pay! Usa meu código {code} no cadastro.',
    invited: 'Convidados', active: 'Ativos', earned: 'Você ganhou',
    howTitle: 'Como funciona', step1: 'Compartilhe seu código com amigos', step2: 'Eles se cadastram com ele',
    step3: 'Eles fazem a primeira transação', step4: 'Você ganha {bonus}',
  },
  agent: {
    ...
    onboardingNote: 'Contas de agente são criadas pelo administrador da Ticash. Peça ao administrador para cadastrar você e depois crie sua senha no primeiro acesso.',
  },
  send: {
...
export const fr: Dictionary = {
  ...
  auth: {
    ...
    forgot: 'Mot de passe oublié ?', firstAccess: 'Première connexion ou mot de passe oublié ?', forgotSubtitle: 'Entrez votre téléphone pour recevoir un code.', codeSent: 'Code envoyé',
    resetTitle: 'Nouveau mot de passe', resetPassword: 'Réinitialiser',
    referralCode: 'Code de parrainage', referralCodeHint: 'Si un ami vous a invité (optionnel)',
  ...
  referral: {
    title: 'Invitez et gagnez', subtitle: 'Partagez votre code. Quand un ami s’inscrit et fait sa première transaction, vous gagnez {bonus}.',
    yourCode: 'Votre code', share: 'Partager', copied: 'Copié',
    shareMessage: 'Rejoignez-moi sur Ticash Pay ! Utilisez mon code {code} à l’inscription.',
    invited: 'Invités', active: 'Actifs', earned: 'Gagné',
    howTitle: 'Comment ça marche', step1: 'Partagez votre code avec vos amis', step2: 'Ils s’inscrivent avec',
    step3: 'Ils font leur première transaction', step4: 'Vous gagnez {bonus}',
  },
  agent: {
    ...
    onboardingNote: 'Les comptes agent sont créés par l’administrateur Ticash. Demandez à votre administrateur de vous enregistrer, puis créez votre mot de passe à la première connexion.',
  },
  send: {
